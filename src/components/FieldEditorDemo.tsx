  ...
  return <div className="flex h-[calc(100vh-74px)] min-h-[720px] overflow-hidden bg-[#ebe8ee]">
    ...
    <main className="min-w-0 flex-1 overflow-auto p-8 scrollbar-thin">
      <div className="mx-auto w-[720px] rounded-lg bg-white p-14 shadow-2xl shadow-[#2e1c42]/20">
        <div className="border-b-2 border-[#2c2038] pb-5"><p className="text-[10px] font-extrabold uppercase tracking-[.2em] text-[#4c00ff]">Valliani Agreements</p><h1 className="mt-2 text-2xl font-extrabold">Jewelry Purchase & Custom Order Agreement</h1><p className="mt-2 text-xs text-[#716678]">Agreement ID: SAMPLE-2026-001</p></div>
        <div className="relative mt-7 min-h-[780px] text-[12px] leading-6 text-[#473a52]">
          ...
          <h2 className="mt-8 text-sm font-extrabold text-[#23152f]">Authorization</h2><p className="mt-3">By signing below, the customer agrees to conduct this transaction electronically and confirms their intent to sign this agreement.</p>
