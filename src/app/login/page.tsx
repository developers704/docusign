    ...
    <main className="grid min-h-screen bg-white lg:grid-cols-[1.1fr_.9fr]">
      <section className="relative hidden overflow-hidden brand-gradient p-12 text-white lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div><p className="text-xl font-extrabold">Valliani Agreements</p><p className="text-[10px] font-bold uppercase tracking-[.2em] text-white/55">Agreement Cloud</p></div>
        </div>
        <div className="relative max-w-xl">
          ...
          <h1 className="mt-6 text-5xl font-extrabold leading-[1.05] tracking-[-.04em] xl:text-6xl">Agreements move faster when every step is connected.</h1>
          <p className="mt-6 max-w-lg text-base leading-7 text-white/70">Prepare, send, sign and track business documents through isolated office workspaces with full audit visibility.</p>
      ...
      <section className="flex min-h-screen items-center justify-center bg-[#fbfafc] px-5 py-10 sm:px-10">
        <div className="w-full max-w-[460px]">
          <div className="mb-10 flex items-center gap-3 lg:hidden"><span className="flex h-10 w-10 items-center justify-center rounded-xl brand-gradient text-white"><span className="h-4 w-4 rotate-45 border-2 border-white"/></span><strong className="text-lg">Valliani Agreements</strong></div>
